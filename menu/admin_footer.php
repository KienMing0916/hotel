        ...
        <div class="container text-center text-md-start mt-5">
            <div class="row mt-3">
                ...
                <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                    ...
                    <hr class="mb-4 mt-0 d-inline-block mx-auto" style="width: 60px; background-color: #7c4dff; height: 2px"/>
                    <p><a href="booking_read.php" class="text-white nav-link">Booking List</a></p>
                    <!-- <p><a href="staff_read.php" class="text-white nav-link">Staff List</a></p>
                    <p><a href="staff_insert.php" class="text-white nav-link">Insert New Staff</a></p> -->
                </div>
